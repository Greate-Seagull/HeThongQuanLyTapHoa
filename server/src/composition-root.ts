...
import { AdjustProductInventoryUsecase } from "./application/services/product/adjust-product-inventory.usecase";
...
export const adjustProductInventoryUsecase = new AdjustProductInventoryUsecase(
  productRepo1
);
